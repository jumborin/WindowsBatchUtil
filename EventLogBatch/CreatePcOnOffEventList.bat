...
wmic ntevent where "(logfile='system' and timewritten >= '%year2%%month2%01' and (eventcode='%START_LOG_ID%' or eventcode='%FINISH_LOG_ID%'))" list /format:CSV | find "," > %TEMP_FILE%
